...
console.log(episodesData.data.episodes.results);
...
console.log(charactersData.data.characters.results);

const EpisodesAll = episodesData.data.episodes.results;
const CharactersAll = charactersData.data.characters.results;

const CharacterList = ({ character: { name } }) => (
  <ul type="square">
    <li className="characters_list">{name}</li>
  </ul>
);
const EpisodeList = ({ episode: { name, air_date } }) => (
  <ul type="square">
    <li className="characters_list">
      <b>{name}</b> {air_date}
    </li>
  </ul>
);
const Episode = ({ episode: { name, air_date, characters } }) => (
  <div className="episode">
    ...
    <p className="episodeDate">{air_date}</p>
...
const Episodes = ({ episodes = EpisodesAll }) => (
...
const Character = ({ character: { name, gender, image, episode } }) => (
  <div className="character">
    ...
    <img className="character_img" src={image}></img>
    <div className="episode_characters">
      {episode.map((episode) => (
...
const Characters = ({ characters = CharactersAll }) => (
